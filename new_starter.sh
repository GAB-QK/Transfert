...
EOF
cd /etc/apache2/
sudo chown -R $utilisateur:www-data /etc/apache2/apache2.conf
sudo chmod -R 2750 /etc/apache2/apache2.conf
...
open_basedir = /srv/http:/srv/www

; This directive allows you to disable certain functions for security reasons.
; It receives a comma-delimited list of function names.
; http://php.net/disable-functions
disable_functions = pcntl_alarm,pcntl_fork,pcntl_waitpid,pcntl_wait,pcntl_wifexited,pcntl_wifstopped,pcntl_wifsignaled,pcntl_wifcontinued,pcntl_wexitstatus,pcntl_wtermsig,pcntl_wstopsig,pcntl_signal,pcntl_signal_get_handler,pcntl_signal_dispatch,pcntl_get_last_error,pcntl_strerror,pcntl_sigprocmask,pcntl_sigwaitinfo,pcntl_sigtimedwait,pcntl_exec,pcntl_getpriority,pcntl_setpriority,pcntl_async_signals,pcntl_unshare,exec,passthru,system,shell_exec,popen,eval,curl_exec,curl_multi_exec,parse_ini_file,show_source,proc_get_status,proc_terminal,proc_open,proc_terminate,proc_close,phpinfo,
...
sudo chown $utilisateur:www-data www.conf
sudo chmod 2750 www.conf
...
sudo cat ~/Transfer/wordpress.txt>/srv/http/WordPress/wp-config.php
